...
## ОБО МНЕ
Веб-разработчик полного цикла: cделаю фронтэнд, бэкэнд, установлю на linux сервер, настрою кэширование. Мои основные языки программирования: JavaScript, Python и PHP.
